(function () {
  ...
  function wa(a) {
    return (
      va[a] ||
      (va[a] = String(a).replace(/\-([a-z])/g, function (a, c) {
  ...
  var Ba = Array.prototype.indexOf
    ...
    D = Array.prototype.forEach
      ...
      : function (a, b, c) {
          for (var d = a.length, e = q(a) ? a.split("") : a, h = 0; h < d; h++)
  ...
  function Ha(a, b, c) {
    if ("array" == n(b))
      for (var d = 0; d < b.length; d++) Ha(a, String(b[d]), c);
    else
      null != b &&
  ...
  var Sa = B("Opera"),
    ...
    K =
      ...
      !(B("Trident") || B("MSIE")) &&
      !B("Edge"),
    Ua = -1 != A.toLowerCase().indexOf("webkit") && !B("Edge");
  function Va() {
    var a = k.document;
  ...
  ab =
    bb && J
      ? Va() || ("CSS1Compat" == bb.compatMode ? parseInt(Za, 10) : 5)
      : void 0;
  function cb(a) {
    M || db();
    eb || (M(), (eb = !0));
  ...
  g.I = function (a, b) {
    ...
    if (c) {
      for (
        var d = Array(arguments.length - 1), e = 1, h = arguments.length;
        e < h;
        e++
      )
        d[e - 1] = arguments[e];
  ...
  g.clear = function (a) {
    if (a) {
      var b = this.b[a];
      b && (D(b, this.F, this), delete this.b[a]);
  ...
  function nb(a) {
    ...
    if (a && b.getElementsByClassName) {
      var h = b.getElementsByClassName(a);
      return h;
    }
    h = b.getElementsByTagName("*");
    if (a) {
      e = {};
      for (c = d = 0; (b = h[c]); c++) {
        var f = b.className,
          l;
        if ((l = "function" == typeof f.split)) l = 0 <= Ba(f.split(/\s+/), a);
        l && (e[d++] = b);
      }
      e.length = d;
      return e;
  ...
  function wb(a) {
    var b = E(document.getElementsByTagName("yt:" + a));
    a = "yt-" + a;
    var c = document;
    a = E(
  ...
  u("ytEventsEventsListeners", w);
  var yb = m("ytEventsEventsCounter") || { count: 0 };
  u("ytEventsEventsCounter", yb);
  function zb(a, b, c, d) {
    d = void 0 === d ? !1 : d;
    a.addEventListener &&
      ...
      D(a, function (a) {
        if (a in w) {
          ...
          d.removeEventListener
            ? d.removeEventListener(e, h, b)
            : d.detachEvent && d.detachEvent("on" + e, h);
          delete w[a];
        }
      }));
  }
  ...
  g.C = function (a) {
    ...
    for (c = 0; c < b.length; c++)
      try {
        ...
        if (l.name && "SyntaxError" == l.name) Ka(l, "WARNING");
        else throw l;
      }
  };
  function W(a) {
  ...
  function Ib(a, b, c) {
    U || ((U = {}), Bb(window, "message", t(a.g, a)));
    U[c] = b;
  }
  W.prototype.g = function (a) {
    if (
      a.origin == T(this, "host") ||
      a.origin == T(this, "host").replace(/^http:/, "https:")
    ) {
      var b;
      try {
        b = ha(a.data);
      ...
      if ((a = U[b.id]))
        (a.B = !0), a.B && (D(a.w, a.C, a), (a.w.length = 0)), a.J(b);
    }
  };
  function Jb(a) {
    W.call(this, a);
  ...
  function Lb(a) {
    ...
    this.a.width = 640;
    this.a.height = 0.67 * T(this, "width");
  }
  v(Lb, W);
  function X(a, b) {
    var c = new Lb(b);
  ...
  function Nb(a, b) {
    if (ba(b)) for (var c in b) a.j[c] = b[c];
  }
  function Ob(a, b) {
    D(
      b,
  ...
  g.V = function () {
    var a;
    a = parseInt(T(this.b, "width"), 10);
    var b = parseInt(T(this.b, "height"), 10);
    var c = T(this.b, "host") + this.u();
    ua.test(c) &&
      (-1 != c.indexOf("&") && (c = c.replace(oa, "&amp;")),
      -1 != c.indexOf("<") && (c = c.replace(pa, "&lt;")),
      -1 != c.indexOf(">") && (c = c.replace(qa, "&gt;")),
      -1 != c.indexOf('"') && (c = c.replace(ra, "&quot;")),
      -1 != c.indexOf("'") && (c = c.replace(sa, "&#39;")),
      -1 != c.indexOf("\x00") && (c = c.replace(ta, "&#0;")));
    a =
      '<iframe width="' +
      a +
      '" height="' +
  ...
  Z.prototype.l = function (a, b) {
    Z.D.l.call(this, a, b ? b.info : void 0);
  };
  ...
  Y.prototype.getVideoEmbedCode = Y.prototype.V;
  Y.prototype.getOptions = Y.prototype.U;
  Y.prototype.getOption = Y.prototype.T;
  X.prototype.setVideoDescription = X.prototype.K;
  X.prototype.setVideoKeywords = X.prototype.M;
  X.prototype.setVideoPrivacy = X.prototype.N;
  X.prototype.setVideoTitle = X.prototype.O;
  X.prototype.setVideoDraftPrivacy = X.prototype.L;
  tb.push(function () {
    var a = wb("player");
    D(a, Mb);
  });
  ...
  var Qb = m("onYTReady");
  Qb && Qb();
  var Rb = m("onYouTubeIframeAPIReady");
  Rb && Rb();
  var Sb = m("onYouTubePlayerAPIReady");
  Sb && Sb();
}.call(this));
